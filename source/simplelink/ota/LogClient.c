...
_i32 LogClient_Print(void *pvLogClient, _u8 *pFilename, OtaApp_statistics_t *pStatistics)
{
    ...
    http_build_request (send_buf, (unsigned char*) "PUT ", pLogClient->pOtaServerInfo->log_server_name, pLogClient->pOtaServerInfo->rest_files_put, log_filename, pLogClient->pOtaServerInfo->rest_hdr, pLogClient->pOtaServerInfo->rest_hdr_val);
