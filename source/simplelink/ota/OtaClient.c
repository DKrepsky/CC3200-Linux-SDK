...
#ifdef TI_OTA_SERVER
    http_build_request (send_buf, (unsigned char*) "GET ", pOtaServerInfo->server_domain, pOtaServerInfo->rest_update_chk, NULL, NULL, NULL);
#else
    http_build_request (send_buf, (unsigned char*) "GET ", pOtaServerInfo->server_domain, pOtaServerInfo->rest_update_chk , pOtaClient->pVendorStr, pOtaServerInfo->rest_hdr, pOtaServerInfo->rest_hdr_val);
#endif
...
#ifdef TI_OTA_SERVER
    http_build_request (send_buf, (unsigned char*) "GET ",  pOtaServerInfo->server_domain, pOtaServerInfo->rest_rsrc_metadata, NULL,             , pOtaServerInfo->rest_hdr, pOtaServerInfo->rest_hdr_val);
#else
    http_build_request (send_buf, (unsigned char*) "POST ", pOtaServerInfo->server_domain, pOtaServerInfo->rest_rsrc_metadata, resource_file_name, pOtaServerInfo->rest_hdr, pOtaServerInfo->rest_hdr_val);
#endif
